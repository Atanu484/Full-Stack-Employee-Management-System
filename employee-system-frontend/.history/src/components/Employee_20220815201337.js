    ...
    return (
        <tr key={employee.id}>
            ...
            <td className='text-right px-6 py-4'>
                <a
                    onClick={(e, id) => editEmployee(e, employee.id)} //Executes the editEmployee method upon click
                    className='text-left text-indigo-500 hover:text-indigo-800 px-6 hover: cursor-pointer'>
                    Edit
                </a>
                <a
                    onClick={(e, id) => deleteEmployee(e, employee.id)} //Executes the deleteEmployee method upon click
