                    ...
                    <tbody className='bg-white'>
                        <tr>
                            ...
                            <td className='text-right px-6 py-4'>
                                <a href='#' className='text-left text-indigo-500 hover:text-indigo-800 px-4'>Edit</a>
                                <a href='#' className='text-right text-indigo-500 hover:text-indigo-800 px-4'>Delete</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
